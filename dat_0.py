...
class TransformerStage(nn.Module):
    ...
    def __init__(self, fmap_size, window_size, ns_per_pt,
        ...
        super().__init__()
        fmap_size = to_2tuple(fmap_size)#56 56
        self.depths = depths
        hc = dim_embed // heads
...
class DAT(nn.Module):
    ...
    #              **kwargs):
    def __init__(self, img_size=224, patch_size=4, num_classes=4, expansion=4,
        ...
        dpr = [x.item() for x in torch.linspace(0, drop_path_rate, sum(depths))]# the number is 0, total 24
